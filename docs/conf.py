...
release = photoshop_python_api.__version__
...
# [howto/manual]).
latex_documents = [
    ('index', 'photoshop_python_api.tex',
     u'photoshop_python_api Documentation',
     u'Long Hao', 'manual'),
]
