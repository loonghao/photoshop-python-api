...
from photoshop.api.enumerations import PDFStandardType
...
class PDFSaveOptions(Photoshop):
    ...
    def destinationProfile(self) -> str:
        ...
        try:
            ...
            raise ValueError("Should set value first. This parameter can only be read after the value has been set.")
